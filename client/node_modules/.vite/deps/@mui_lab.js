import {
  ...
  Typography_default,
  usePagination
} from "./chunk-3Y2XQWCY.js";
import {
  TabPanel_default,
  getTabPanelUtilityClass,
  tabPanelClasses_default
} from "./chunk-KHXIZ4ED.js";
import {
  useAutocomplete
} from "./chunk-PESNQAPR.js";
import {
  TabList_default
} from "./chunk-Y2JEDVIA.js";
import {
  capitalize_default,
  isMuiElement_default,
  useId_default
} from "./chunk-YED3HWGF.js";
import "./chunk-JI7SOBIZ.js";
import {
  TabContext,
  getPanelId,
  getTabId,
  useTabContext
} from "./chunk-SA2S5HDB.js";
import {
  require_react_dom
} from "./chunk-YAPSZIQJ.js";
import "./chunk-BQHDDXPT.js";
import {
  _extends,
...
var TreeItem = React46.forwardRef(function DeprecatedTreeItem() {
  warn24();
  return null;
});
...
var TreeView = React47.forwardRef(function DeprecatedTreeView() {
  warn25();
  return null;
});
...
var _excluded9 = ["children", "className", "component", "columns", "spacing", "sequential", "defaultColumns", "defaultHeight", "defaultSpacing"];
...
var Masonry = React48.forwardRef(function Masonry2(inProps, ref) {
  ...
  const handleResize = React48.useCallback((masonryChildren) => {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index) => (0, import_jsx_runtime23.jsx)("span", {
...
true ? Masonry.propTypes = {
   ...
   * @default false
   */
  sequential: import_prop_types9.default.bool,
  /**
