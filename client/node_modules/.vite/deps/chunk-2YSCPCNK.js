...
function useIsFocusVisible() {
  const ref = React16.useCallback((node3) => {
    if (node3 != null) {
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match3, setMatch] = React19.useState(() => {
    if (noSsr && matchMedia) {
...
var positions_default = compose_default(position3, zIndex2, top, right, bottom, left);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2YSCPCNK.js.map
